...
#define UE_PROJECT_NAME HexagonMapping
#define UE_TARGET_NAME HexagonMappingEditor
#define UE_MODULE_NAME "HexagonMapping"
...
#define HEXAGONMAPPING_API DLLEXPORT
